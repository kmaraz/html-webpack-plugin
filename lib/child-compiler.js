 ...
 */
'use strict';
const NodeTemplatePlugin = require('webpack4/lib/node/NodeTemplatePlugin');
const NodeTargetPlugin = require('webpack4/lib/node/NodeTargetPlugin');
const LoaderTargetPlugin = require('webpack4/lib/LoaderTargetPlugin');
const LibraryTemplatePlugin = require('webpack4/lib/LibraryTemplatePlugin');
const SingleEntryPlugin = require('webpack4/lib/SingleEntryPlugin');
...
function extractHelperFilesFromCompilation (mainCompilation, childCompilation, filename, childEntryChunks) {
  ...
  const helperAssetNames = childEntryChunks.map((entryChunk, index) => {
    ...
    return mainCompilation.mainTemplate.getAssetPath(filename, entryConfig);
  });
